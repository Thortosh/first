...
$sqllot = "SELECT l.id as id, c.name as category_name, categories_id, l.name, path, startprice, description FROM lots l JOIN categories c ON l.categories_id = c.id";  // Тело запроса
